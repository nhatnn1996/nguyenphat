...
const Introduce = () => {
  return (
    <div id="content" className="container content-area page-wrapper" role="main" style={{ minHeight: '70vh' }}>
      ...
      chất xây dựng Cung cấp máy móc và thiết bị sửa chữa công trình Tư vấn và Thi công chống thấm cho các công trình Xử
      lý nứt bê tông Xử lý rò rỉ nước cho các hạng muc công trình Hoàn thiện công trình xây dựng Chúng tôi tin rằng với
      những giải pháp chống thấm tối ưu, cùng vật liệu đa dạng, chất lượng và giá cả hợp lí CÔNG TY TNHH ĐẦU TƯ XÂY DỰNG
      THƯƠNG MẠI NGUYÊN PHÁT sẽ mang đến cho Quý khách những công trình hoàn hảo và mang giá trị bền vững
    </div>
  );
};
